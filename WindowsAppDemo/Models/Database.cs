    ...
    public static class Database
    {
       static public List<Book> Books { get; set; }
        static public List<Book>  PopulateBooks()
        {
            ...
            Books.Add(new Book { Title = "The Hobbit", Author = "J.R.R. Tolkien", YearPublished = 1937, Genre = "Fantasy" });
            Books.Add(new Book { Title = "The Hobbit", Author = "J.R.R. Tolkien", YearPublished = 1938, Genre = "Fantasy" });
            Books.Add(new Book { Title = "The Hobbit", Author = "J.R.R. Tolkien", YearPublished = 1939, Genre = "Fantasy" });
            Books.Add(new Book { Title = "The Hobbit", Author = "J.R.R. Tolkien", YearPublished = 1936, Genre = "Fantasy" });
            return Books;
        }
    }
}
